...
pub struct ListChecksQuery<'c, 'a, 's, C: GenericClient, T, const N: usize> {
    ...
    extractor: fn(
        &tokio_postgres::Row,
    ) -> Result<ListChecksBorrowed, tokio_postgres::Error>,
...
pub struct GetCheckQuery<'c, 'a, 's, C: GenericClient, T, const N: usize> {
    ...
    extractor: fn(
        &tokio_postgres::Row,
    ) -> Result<GetCheckBorrowed, tokio_postgres::Error>,
    ...
    C: GenericClient,
{
    pub fn map<R>(
        self,
        mapper: fn(GetCheckBorrowed) -> R,
    ) -> GetCheckQuery<'c, 'a, 's, C, R, N> {
        GetCheckQuery {
            client: self.client,
            params: self.params,
            query: self.query,
...
pub struct GetCheckGroupQuery<'c, 'a, 's, C: GenericClient, T, const N: usize> {
    ...
    extractor: fn(
        &tokio_postgres::Row,
    ) -> Result<GetCheckGroupBorrowed, tokio_postgres::Error>,
