...
pub struct CreateVariantQuery<'c, 'a, 's, C: GenericClient, T, const N: usize> {
    ...
    extractor: fn(
        &tokio_postgres::Row,
    ) -> Result<CreateVariantBorrowed, tokio_postgres::Error>,
...
pub struct ListVariantsQuery<'c, 'a, 's, C: GenericClient, T, const N: usize> {
    ...
    extractor: fn(
        &tokio_postgres::Row,
    ) -> Result<ListVariantsBorrowed, tokio_postgres::Error>,
...
pub struct UpdatePerformanceMetricsQuery<
    'c,
    'a,
    's,
    C: GenericClient,
...
impl<
    ...
    T: 'c,
    const N: usize,
> UpdatePerformanceMetricsQuery<'c, 'a, 's, C, T, N>
where
    C: GenericClient,
{
    pub fn map<R>(
...
pub struct DeactivateVariantsForAgentStmt(
    &'static str,
