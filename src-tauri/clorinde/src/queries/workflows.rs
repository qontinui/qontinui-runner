...
pub fn list_unified_workflows() -> ListUnifiedWorkflowsStmt {
    ListUnifiedWorkflowsStmt(
        "SELECT id, name, description, category, tags, setup_steps, verification_steps, agentic_steps, completion_steps, max_iterations, provider, model, skip_ai_summary, created_at, updated_at, log_source_selection, context_ids, disabled_context_ids, auto_include_contexts, prompt_template, log_watch_enabled, health_check_enabled, health_check_urls, timeout_seconds, preflight_check_enabled, generated_by_task_run_id, enable_sweep, max_sweep_iterations, stages, stop_on_failure, reflection_mode, model_overrides, approval_gate, completion_prompts_first, is_favorite, dependency_graph, cost_annotations, quality_report, acceptance_criteria, constraint_overrides, COALESCE(ai_reviewed, true) as ai_reviewed, workflow_architecture, rollback_policy, strict_cwd, tool_tags, enforce_token_budget, flow_control_json, phase_timeouts_json FROM unified_workflows ORDER BY is_favorite DESC, updated_at DESC",
        None,
    )
}
...
pub fn get_unified_workflow() -> GetUnifiedWorkflowStmt {
    GetUnifiedWorkflowStmt(
        "SELECT id, name, description, category, tags, setup_steps, verification_steps, agentic_steps, completion_steps, max_iterations, provider, model, skip_ai_summary, created_at, updated_at, log_source_selection, context_ids, disabled_context_ids, auto_include_contexts, prompt_template, log_watch_enabled, health_check_enabled, health_check_urls, timeout_seconds, preflight_check_enabled, generated_by_task_run_id, enable_sweep, max_sweep_iterations, stages, stop_on_failure, reflection_mode, model_overrides, approval_gate, completion_prompts_first, is_favorite, dependency_graph, cost_annotations, quality_report, acceptance_criteria, constraint_overrides, COALESCE(ai_reviewed, true) as ai_reviewed, workflow_architecture, rollback_policy, strict_cwd, tool_tags, enforce_token_budget, flow_control_json, phase_timeouts_json FROM unified_workflows WHERE id = $1",
        None,
    )
}
...
pub fn get_unified_workflow_by_name() -> GetUnifiedWorkflowByNameStmt {
    GetUnifiedWorkflowByNameStmt(
        "SELECT id, name, description, category, tags, setup_steps, verification_steps, agentic_steps, completion_steps, max_iterations, provider, model, skip_ai_summary, created_at, updated_at, log_source_selection, context_ids, disabled_context_ids, auto_include_contexts, prompt_template, log_watch_enabled, health_check_enabled, health_check_urls, timeout_seconds, preflight_check_enabled, generated_by_task_run_id, enable_sweep, max_sweep_iterations, stages, stop_on_failure, reflection_mode, model_overrides, approval_gate, completion_prompts_first, is_favorite, dependency_graph, cost_annotations, quality_report, acceptance_criteria, constraint_overrides, COALESCE(ai_reviewed, true) as ai_reviewed, workflow_architecture, rollback_policy, strict_cwd, tool_tags, enforce_token_budget, flow_control_json, phase_timeouts_json FROM unified_workflows WHERE name = $1 LIMIT 1",
        None,
    )
}
...
pub fn search_unified_workflows() -> SearchUnifiedWorkflowsStmt {
    SearchUnifiedWorkflowsStmt(
        "SELECT id, name, description, category, tags, setup_steps, verification_steps, agentic_steps, completion_steps, max_iterations, provider, model, skip_ai_summary, created_at, updated_at, log_source_selection, context_ids, disabled_context_ids, auto_include_contexts, prompt_template, log_watch_enabled, health_check_enabled, health_check_urls, timeout_seconds, preflight_check_enabled, generated_by_task_run_id, enable_sweep, max_sweep_iterations, stages, stop_on_failure, reflection_mode, model_overrides, approval_gate, completion_prompts_first, is_favorite, dependency_graph, cost_annotations, quality_report, acceptance_criteria, constraint_overrides, COALESCE(ai_reviewed, true) as ai_reviewed, workflow_architecture, rollback_policy, strict_cwd, tool_tags, enforce_token_budget, flow_control_json, phase_timeouts_json FROM unified_workflows WHERE to_tsvector('english', name || ' ' || COALESCE(description, '')) @@ plainto_tsquery('english', $1) OR name ILIKE '%' || $1 || '%' OR category ILIKE '%' || $1 || '%' ORDER BY is_favorite DESC, updated_at DESC",
        None,
    )
}
...
pub fn get_pending_sync_workflows() -> GetPendingSyncWorkflowsStmt {
    GetPendingSyncWorkflowsStmt(
        "SELECT id, name, description, category, tags, setup_steps, verification_steps, agentic_steps, completion_steps, max_iterations, provider, model, skip_ai_summary, created_at, updated_at, log_source_selection, context_ids, disabled_context_ids, auto_include_contexts, prompt_template, log_watch_enabled, health_check_enabled, health_check_urls, timeout_seconds, preflight_check_enabled, generated_by_task_run_id, enable_sweep, max_sweep_iterations, stages, stop_on_failure, reflection_mode, model_overrides, approval_gate, completion_prompts_first, is_favorite, dependency_graph, cost_annotations, quality_report, acceptance_criteria, constraint_overrides, COALESCE(ai_reviewed, true) as ai_reviewed, workflow_architecture, rollback_policy, strict_cwd, tool_tags, enforce_token_budget, flow_control_json, phase_timeouts_json FROM unified_workflows WHERE sync_pending = true",
        None,
    )
}
