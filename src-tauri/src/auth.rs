...
pub(crate) fn select_device_bearer_result(
    ...
    select_device_bearer_result_with(am, tenant, default_tenant, measured_device_binding_count())
}

/// [`select_device_bearer_result`] with the device's MEASURED binding count
