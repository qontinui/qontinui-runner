...
impl PgDb {
    ...
    pub async fn insert_snapshot(
        ...
        let row = conn
            ...
            .await
            .map_err(|e| {
                crate::database::pg::pg_err("Failed to insert session_file_snapshot", &e)
            })?;
    ...
    pub async fn get_snapshots_for_session(
        ...
        let rows = conn
            ...
            .await
            .map_err(|e| {
                crate::database::pg::pg_err("Failed to list session_file_snapshots", &e)
            })?;
    ...
    pub async fn prune_snapshots_older_than(&self, days: i32) -> Result<(usize, usize), String> {
        ...
        let rows = conn
            ...
            .await
            .map_err(|e| {
                crate::database::pg::pg_err("Failed to scan for prunable snapshots", &e)
            })?;
        ...
        let deleted = conn
            ...
            .await
            .map_err(|e| crate::database::pg::pg_err("Failed to delete old snapshots", &e))?
            as usize;
