...
impl PgDb {
    ...
    pub async fn get_element_interactions(
        &self,
        task_run_id: i64,
    ...
    pub async fn get_flaky_elements(
        &self,
    ...
    pub async fn get_element_reliability(
        &self,
        element_id: &str,
    ...
    pub async fn get_stall_events(&self, task_run_id: &str) -> Result<Vec<StallEvent>, String> {
        ...
        Ok(rows
            ...
            .map(|r| StallEvent {
                ...
                action_count: if r.action_count == 0 {
                    None
                } else {
                    Some(r.action_count as i64)
                },
    ...
    pub async fn get_element_decay_curve(
        &self,
        element_id: &str,
        window_ms: i64,
        num_windows: i64,
    ...
    pub async fn get_action_latency_baselines(
        &self,
        since_epoch_ms: i64,
    ...
    pub async fn get_failure_taxonomy(
        &self,
        since_epoch_ms: i64,
        limit: i64,
    ...
    pub async fn get_element_fragility_by_region(
        &self,
        since_epoch_ms: i64,
    ...
    pub async fn get_automation_regressions(
        &self,
        since_epoch_ms: i64,
        limit: i64,
    ...
    pub async fn get_stall_frequency(
        &self,
        since_timestamp: &str,
        ...
        let conn = self
            ...
            .await
            .map_err(|e| format!("PG pool error: {}", e))?;
        let ts: chrono::DateTime<chrono::FixedOffset> = since_timestamp
            .parse()
    ...
    pub async fn get_intervention_effectiveness(
        &self,
        since_timestamp: &str,
    ...
    pub async fn get_unannotated_high_interaction_elements(
        &self,
        min_interactions: i64,
