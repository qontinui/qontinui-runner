//! Settings, config storage, and JSON file migration operations.
//!
//! Contains all CheckpointDb methods related to settings, config storage, and migration from JSON files.
