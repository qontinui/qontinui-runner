...
In `MERGE_DECISION`, citations go into `rationale` and
`preconditions_verified` in this grammar — the "grep the route literal, not
the line" rule under Input, made a contract. Enforced by check #51's agent-body arm
