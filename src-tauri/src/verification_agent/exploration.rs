...
//! during verification. Each strategy has different trade-offs between coverage,
...
/// Exploration strategy for state machine verification
...
pub enum ExplorationStrategy {
    ...
    RandomWalk,
    /// Verify only specific states/transitions provided in config
    Targeted,
}
...
pub struct StateVisit {
    ...
    /// Priority for verification order
    pub priority: u32,
}
...
impl StateExplorer {
    ...
    /// Targeted - verify only specific states/transitions
