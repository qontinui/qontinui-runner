  ...
  return (
    <div className="container">
      ...
      <div className="status-bar">
        ...
        {currentState && <span className="status-indicator">State: {currentState}</span>}
      </div>

      <div className="control-panel">
        <div className="section">
          <h2>Configuration</h2>
          <button onClick={selectConfigFile}>Load Configuration</button>
          {configPath && <div className="config-path">{configPath}</div>}
        </div>
        ...
        <div className="section">
          ...
          <button onClick={startPythonExecutor} disabled={pythonRunning}>
            Start Python
          </button>
          <button onClick={stopPythonExecutor} disabled={!pythonRunning}>
            Stop Python
          </button>
        </div>
        ...
        <div className="section">
          ...
          <button onClick={stopExecution} disabled={!executionRunning}>
            Stop Execution
          </button>
        </div>
      </div>
