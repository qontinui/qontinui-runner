    ...
    <div className="w-1/2 flex flex-col">
      ...
      <div className="px-4 py-3 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-h3 text-gray-300">Execution Queue</h2>
          {items.length > 0 && (
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {items.length === 0 ? (
          <div
            className="flex flex-col items-center justify-center h-full border-2 border-dashed border-white/10 rounded-lg text-gray-500"
            onDragOver={(e) => e.preventDefault()}
          >
            <Inbox className="w-10 h-10 mb-3 text-gray-600" />
            <p className="text-body font-medium text-gray-400">Queue is empty</p>
