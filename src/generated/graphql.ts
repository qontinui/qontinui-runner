...
export type CostEvent = GqlBudgetWarningEvent | GqlCostAnomalyEvent | GqlCostUpdateEvent;
...
export type GqlBudgetWarningEvent = {
  ...
  remainingFraction: Scalars["Float"]["output"];
  taskRunId: Scalars["String"]["output"];
...
export type GqlCostAnomalyEvent = {
  costUsd: Scalars["Float"]["output"];
  meanCostUsd: Scalars["Float"]["output"];
  message: Scalars["String"]["output"];
...
export type GqlErrorEvent = {
  ...
  logSourceName: Scalars["String"]["output"];
  message: Scalars["String"]["output"];
  ...
  taskRunId?: Maybe<Scalars["String"]["output"]>;
};

/** A detected pattern across multiple errors. */
export type GqlErrorPattern = {
  description?: Maybe<Scalars["String"]["output"]>;
  errorIds: Array<Scalars["Int"]["output"]>;
...
export type GqlLoopInstanceStatus = {
  currentIteration: Scalars["Int"]["output"];
  error?: Maybe<Scalars["String"]["output"]>;
  isPipeline: Scalars["Boolean"]["output"];
  label?: Maybe<Scalars["String"]["output"]>;
  loopId: Scalars["String"]["output"];
  /** `None` means the loop has no iteration cap (unlimited). */
  maxIterations?: Maybe<Scalars["Int"]["output"]>;
  phase: Scalars["String"]["output"];
  running: Scalars["Boolean"]["output"];
  startedAt?: Maybe<Scalars["String"]["output"]>;
  targetRunnerId?: Maybe<Scalars["String"]["output"]>;
  targetRunnerPort: Scalars["Int"]["output"];
  workflowId: Scalars["String"]["output"];
};

/** Multi-loop aggregated status. */
export type GqlMultiLoopStatus = {
  allComplete: Scalars["Boolean"]["output"];
  anyError: Scalars["Boolean"]["output"];
  loops: Array<GqlLoopInstanceStatus>;
  stopAllOnError: Scalars["Boolean"]["output"];
};
...
export type GqlTaskRun = {
  ...
  blocksParent: Scalars["Boolean"]["output"];
  ...
  isReview: Scalars["Boolean"]["output"];
...
export type QueryRoot = {
  ...
  errorEvents: Array<GqlErrorEvent>;
  /**
   ...
   */
  errorPatterns: Array<GqlErrorPattern>;
  /** Get error summary statistics, optionally scoped to a task run. */
  errorSummary: GqlErrorSummary;
...
export type QueryRootErrorEventsArgs = {
  limit?: Scalars["Int"]["input"];
  severity?: InputMaybe<Scalars["String"]["input"]>;
  status?: InputMaybe<Scalars["String"]["input"]>;
  taskRunId?: InputMaybe<Scalars["String"]["input"]>;
};
...
export type QueryRootErrorSummaryArgs = {
  taskRunId?: InputMaybe<Scalars["String"]["input"]>;
};
...
export type SubscriptionRoot = {
   ...
   */
  multiOrchestrationLoopStatusStream: GqlMultiLoopStatus;
  /**
...
export type SubscriptionRootCostEventsArgs = {
  taskRunId?: InputMaybe<Scalars["String"]["input"]>;
};
...
export type SubscriptionRootMultiOrchestrationLoopStatusStreamArgs = {
  intervalMs?: Scalars["Int"]["input"];
};
...
export type CostEventsSubscriptionVariables = Exact<{
  taskRunId?: InputMaybe<Scalars["String"]["input"]>;
}>;

export type CostEventsSubscription = {
  costEvents:
    | {
        taskRunId: string;
