 ...
 */
export type RunnerEvent = AiOutputChunkEvent | FindingDetectedEvent | FindingResolvedEvent | GenericRunnerEvent | OrchestratorStateChangeEvent | StepProgressEvent | TaskRunUpdateEvent;
...
export type TaskRunFieldsFragment = { id: string, taskName: string, prompt?: string | null, taskType: string, status: string, sessionsCount: number, maxSessions?: number | null, autoContinue: boolean, errorMessage?: string | null, configId?: string | null, workflowName?: string | null, workflowId?: string | null, summary?: string | null, goalAchieved?: boolean | null, remainingWork?: string | null, workflowType?: string | null, parentTaskRunId?: string | null, rootTaskRunId?: string | null, depth: number, isReflection: boolean, isFollowUp: boolean, isFixer: boolean, isMetaOptimizer: boolean, createdAt: string, updatedAt: string, completedAt?: string | null };

export type FindingFieldsFragment = { id: string, taskRunId: string, sessionNum: number, category: GqlFindingCategory, severity: GqlFindingSeverity, status: GqlFindingStatus, actionType: GqlFindingActionType, title: string, description: string, resolution?: string | null, signatureHash: string, userResponse?: string | null, detectedAt: string, resolvedAt?: string | null, resolvedInSession?: number | null, updatedAt: string, codeContext?: { file?: string | null, line?: number | null, column?: number | null, snippet?: string | null } | null };
...
export type TaskRunsQuery = { taskRuns: Array<{ id: string, taskName: string, prompt?: string | null, taskType: string, status: string, sessionsCount: number, maxSessions?: number | null, autoContinue: boolean, errorMessage?: string | null, configId?: string | null, workflowName?: string | null, workflowId?: string | null, summary?: string | null, goalAchieved?: boolean | null, remainingWork?: string | null, workflowType?: string | null, parentTaskRunId?: string | null, rootTaskRunId?: string | null, depth: number, isReflection: boolean, isFollowUp: boolean, isFixer: boolean, isMetaOptimizer: boolean, createdAt: string, updatedAt: string, completedAt?: string | null }> };
...
export type TaskRunQuery = { taskRun?: { id: string, taskName: string, prompt?: string | null, taskType: string, status: string, sessionsCount: number, maxSessions?: number | null, autoContinue: boolean, errorMessage?: string | null, configId?: string | null, workflowName?: string | null, workflowId?: string | null, summary?: string | null, goalAchieved?: boolean | null, remainingWork?: string | null, workflowType?: string | null, parentTaskRunId?: string | null, rootTaskRunId?: string | null, depth: number, isReflection: boolean, isFollowUp: boolean, isFixer: boolean, isMetaOptimizer: boolean, createdAt: string, updatedAt: string, completedAt?: string | null } | null };

export type RunningTaskRunsQueryVariables = Exact<{ [key: string]: never; }>;


export type RunningTaskRunsQuery = { runningTaskRuns: Array<{ id: string, taskName: string, prompt?: string | null, taskType: string, status: string, sessionsCount: number, maxSessions?: number | null, autoContinue: boolean, errorMessage?: string | null, configId?: string | null, workflowName?: string | null, workflowId?: string | null, summary?: string | null, goalAchieved?: boolean | null, remainingWork?: string | null, workflowType?: string | null, parentTaskRunId?: string | null, rootTaskRunId?: string | null, depth: number, isReflection: boolean, isFollowUp: boolean, isFixer: boolean, isMetaOptimizer: boolean, createdAt: string, updatedAt: string, completedAt?: string | null }> };

export type WorkflowsQueryVariables = Exact<{ [key: string]: never; }>;


export type WorkflowsQuery = { workflows: Array<{ id: string, name: string, description: string, category: string, tags: Array<string>, maxIterations: number, timeoutSeconds?: number | null, provider?: string | null, model?: string | null, isFavorite: boolean, multiAgentMode: boolean, workflowArchitecture?: string | null, stageCount: number, createdAt: string, updatedAt: string }> };
...
export type WorkflowQuery = { workflow?: { id: string, name: string, description: string, category: string, tags: Array<string>, setupSteps: unknown, verificationSteps: unknown, agenticSteps: unknown, completionSteps: unknown, maxIterations: number, timeoutSeconds?: number | null, provider?: string | null, model?: string | null, isFavorite: boolean, multiAgentMode: boolean, reflectionMode: boolean, approvalGate: boolean, stopOnFailure: boolean, useWorktree: boolean, strictCwd: boolean, enforceTokenBudget: boolean, workflowArchitecture?: string | null, stages: unknown, createdAt: string, updatedAt: string } | null };
...
export type FindingsQuery = { findings: Array<{ id: string, taskRunId: string, sessionNum: number, category: GqlFindingCategory, severity: GqlFindingSeverity, status: GqlFindingStatus, actionType: GqlFindingActionType, title: string, description: string, resolution?: string | null, signatureHash: string, userResponse?: string | null, detectedAt: string, resolvedAt?: string | null, resolvedInSession?: number | null, updatedAt: string, codeContext?: { file?: string | null, line?: number | null, column?: number | null, snippet?: string | null } | null }> };
...
export type FindingSummaryQuery = { findingSummary: { taskRunId: string, total: number, byCategory: unknown, bySeverity: unknown, byStatus: unknown, needsInputCount: number, resolvedCount: number, outstandingCount: number } };
...
export type TaskRunOutputQuery = { taskRunOutput: { taskRunId: string, content: string, totalLength: number, offset: number, hasMore: boolean } };

export type RunnerStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type RunnerStatusQuery = { runnerStatus: { instanceName?: string | null, apiPort: number, executorRunning: boolean, executorState: string, configLoaded: boolean, configPath?: string | null, aiAnalysisRunning: boolean } };

export type OrchestrationLoopStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type OrchestrationLoopStatusQuery = { orchestrationLoopStatus: { running: boolean, phase: string, currentIteration: number, startedAt?: string | null, error?: string | null } };

export type UiBridgeHealthQueryVariables = Exact<{ [key: string]: never; }>;


export type UiBridgeHealthQuery = { uiBridgeHealth: { responsive: boolean, lastHeartbeat: string, heartbeatAgeMs: string, uptimeSeconds: string, pendingRequests: number, circuitBreaker: CircuitBreakerState, semaphoreAvailable: number } };
...
export type CreateTaskRunMutation = { createTaskRun: { id: string, taskName: string, prompt?: string | null, taskType: string, status: string, sessionsCount: number, maxSessions?: number | null, autoContinue: boolean, errorMessage?: string | null, configId?: string | null, workflowName?: string | null, workflowId?: string | null, summary?: string | null, goalAchieved?: boolean | null, remainingWork?: string | null, workflowType?: string | null, parentTaskRunId?: string | null, rootTaskRunId?: string | null, depth: number, isReflection: boolean, isFollowUp: boolean, isFixer: boolean, isMetaOptimizer: boolean, createdAt: string, updatedAt: string, completedAt?: string | null } };
...
export type RunWorkflowMutation = { runWorkflow: { id: string, taskName: string, prompt?: string | null, taskType: string, status: string, sessionsCount: number, maxSessions?: number | null, autoContinue: boolean, errorMessage?: string | null, configId?: string | null, workflowName?: string | null, workflowId?: string | null, summary?: string | null, goalAchieved?: boolean | null, remainingWork?: string | null, workflowType?: string | null, parentTaskRunId?: string | null, rootTaskRunId?: string | null, depth: number, isReflection: boolean, isFollowUp: boolean, isFixer: boolean, isMetaOptimizer: boolean, createdAt: string, updatedAt: string, completedAt?: string | null } };
...
export type UiBridgeHealthStreamSubscription = { uiBridgeHealthStream: { responsive: boolean, lastHeartbeat: string, heartbeatAgeMs: string, uptimeSeconds: string, pendingRequests: number, circuitBreaker: CircuitBreakerState, semaphoreAvailable: number } };
...
export type RunnerEventsSubscription = { runnerEvents:
    | { taskRunId: string, chunk: string, accumulatedLength: number }
    | { finding: unknown }
    | { finding: unknown }
    | { eventType: string, data: unknown }
    | { taskRunId: string, workflowStage: string, iteration?: number | null, phase: string, stateData?: unknown | null }
    | { taskRunId: string, stepIndex: number, stepName: string, status: string, details?: unknown | null, timestamp: string }
    | { taskRunId: string, status: string, iteration?: number | null, details?: unknown | null, timestamp: string }
   };
...
export type TaskRunProgressSubscription = { taskRunProgress:
    | { taskRunId: string, chunk: string, accumulatedLength: number }
    | { eventType: string, data: unknown }
    | { taskRunId: string, workflowStage: string, iteration?: number | null, phase: string, stateData?: unknown | null }
    | { taskRunId: string, stepIndex: number, stepName: string, status: string, details?: unknown | null, timestamp: string }
...
export type OrchestrationLoopStatusStreamSubscription = { orchestrationLoopStatusStream: { running: boolean, phase: string, currentIteration: number, startedAt?: string | null, error?: string | null } };
